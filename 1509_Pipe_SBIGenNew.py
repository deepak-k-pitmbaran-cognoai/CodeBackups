    ...
    try:
        ...
        if str(r.status_code) == '200':
            if content == [] or content == {} or content == 'null' or content == 'None' or content is None:
                json_response['data']['claim_details'] = 'We are not able to process your request at this point of time. Please try again after sometime'

            elif content != [] or content != {} or content != 'null' or content != 'None' or content is not None:    
                json_response['status_message'] = "Ok"
                json_response['data']['claim_details'] = "Your Claim Number is: <b>"+content['responseBody'].split('<ClaimNo>')[1].split(
                ...
                json_response['data']['claim_details'] = 'We are not able to fetch your claim details, Kindly chat with expert.'
                json_response['status_message'] = "REDO"
        
        else:
            json_response['data']['claim_details'] = 'We are not able to process your request at this point of time due to connectivity issues. Please try again after sometime'
            json_response['status_message'] = "API Error"

        return json_response
    
    except requests.Timeout as E:
        json_response['data']['claim_details'] = 'We are not able to process your request due to connectivity failure. Please try again after sometime.'
