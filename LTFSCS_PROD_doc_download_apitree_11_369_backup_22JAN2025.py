...
def f():
    ...
    try:
        ...
        # disbursement_date = '{/DisbursementDate/}'[:-9]
        email = ""
        ...
        try:
            ...
            response['API_REQUEST_PACKET'] = {"url":noc_count_url,"headers":noc_count_headers,"data":noc_count_payload}
            response['API_RESPONSE_PACKET']['NOC_Count_Resp'] = {"response":str(E)}
            return response
        
        response['API_RESPONSE_PACKET']['NOC_Count_Resp'] = {"response":noc_count_response.text}
...
#                response[f'doc_{doc}_payload'] = payload
                ...
                try:
                    ...
                    response['recommendations'] = result_dict['options'](lob)
                    response['API_REQUEST_PACKET'] = {"url":url,"headers":headers,"data":payload}
                    response['API_RESPONSE_PACKET'][f'NOC_Resp_{noc_doc_api_ctr}'] = {"response":str(E)}
                    return response

#                response[f'doc_{doc}_response'] = resp.text
...
#                    response['API_RESPONSE_PACKET'] = {"response":resp}
                    ...
                    if resp['statusCode'] == '000':
                        ...
                        if lob in ['Two Wheeler','Farm']:
                            doc_show = f"Dear Customer,<br><br>As requested by you please find below the NOC, NDC, and Form 35 for your Loan No. {LAN}."
                        else:
                            doc_show = f"Dear Customer,<br><br>As requested by you please find below the NDC for your Loan No. {LAN}."
...
#                doc_show = "If you still wish to download the NOC, a minimal amount of <b>Rs.295.00</b> to be paid as service charges. Click on the below link to proceed with the charges payment.<br/><br/>"
#                doc_show += "https://selfhelpuat.ltfs.com/SHO-Microsite/#/login?id=15"
#                response['recommendations'] = ['Main Menu']
#                response['status_code'] = 200
#            else:
#                doc_show = "If you still wish to download the NOC, a minimal amount of <b>Rs.1180.00</b> to be paid as service charges. Click on the below link to proceed with the charges payment.<br/><br/>"
#                doc_show += "https://selfhelpuat.ltfs.com/SHO-Microsite/#/login?id=15"
#                response['recommendations'] = ['Main Menu']
#                response['status_code'] = 200
        else:
            ...
            if lob in ['Two Wheeler', 'Consumer Loan']:
                ...
                doc_show += "Click here https://selfhelp.ltfs.com/SHO-Microsite/#/login?id=15 to pay a nominal fee of <b>Rs.295.00</b> and avail your NOC."
                response['recommendations'] = ['Main Menu']
                response['status_code'] = 200
            else:
                ...
                doc_show += "Click here https://selfhelp.ltfs.com/SHO-Microsite/#/login?id=15 to pay a nominal fee of <b>Rs.1180.00</b> and avail your NOC."
                response['recommendations'] = ['Main Menu']
                response['status_code'] = 200
